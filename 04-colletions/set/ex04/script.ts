//script tera um set do tipo number inicializada com 10 numeros inteiros, solicita qual numero ele deseja encontrar e exibi no terminal,e caso ele nao seja encontrado exibir a mensagem que ele nao foi encontrado

//import do readLine-sync
import readLine = require('readline-sync');

//declaração do array tipo number
const colecaoNumeros: Set<number> = new Set<number>([2, 5, 1, 3, 4, 9, 7, 8, 10, 6]);
...
do {
    ...
    //verifica se o numero existe dentro do set e retorna uma mensagem na tela
    if (colecaoNumeros.has(numeroBusca)) {
        console.clear();
